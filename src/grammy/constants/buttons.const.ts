...
export const BUTTONS = {
  ...
  [CommandEnum.GET_ACCESS]: {
    text: '🔥 Купить',
    callback_data: CommandEnum.GET_ACCESS,
  },
  [CommandEnum.JOIN_CHAT]: {
    text: 'Открыть чат',
    url: 'https://t.me/openpnbot',
  },

  [CommandEnum.PAY_WITH_YOOMONEY]: {
    text: '💳 картой РФ',
    callback_data: CommandEnum.PAY_WITH_YOOMONEY,
  },
