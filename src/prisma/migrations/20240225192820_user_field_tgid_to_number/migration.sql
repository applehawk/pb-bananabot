/*
  ...
  - You are about to alter the column `tgid` on the `Connection` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
...
INSERT INTO "new_User" ("connLimit", "firstname", "key_id", "lastname", "nickname") SELECT "connLimit", "firstname", "key_id", "lastname", "nickname" FROM "User";
DROP TABLE "User";
